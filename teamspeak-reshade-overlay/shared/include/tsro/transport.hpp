...
#ifndef TSRO_TRANSPORT_HPP
#define TSRO_TRANSPORT_HPP
...
/// missing endpoint (TeamSpeak not running or the plugin not loaded) is the normal case and is

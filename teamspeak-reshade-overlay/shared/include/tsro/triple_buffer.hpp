...
//
// This is what lets the render thread pick up the newest TeamSpeak state with one atomic
...
#ifndef TSRO_TRIPLE_BUFFER_HPP
#define TSRO_TRIPLE_BUFFER_HPP
